...
import pw.binom.dns.protocol.records.caa
import pw.binom.dns.protocol.records.https
...
import pw.binom.dns.protocol.records.srv
...
fun Resource.normalizedRdata(): RData? {
    ...
    return when (type) {
        ...
        DnsType.SRV -> RData.srv(rdata.srv())
        DnsType.CAA -> RData.caa(rdata.caa())
        DnsType.HTTPS -> RData.https(rdata.https())
        else -> {
